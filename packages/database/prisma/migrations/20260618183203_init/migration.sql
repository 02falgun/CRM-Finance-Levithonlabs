...
CREATE TABLE "Invoice" (
    ...
    "billDateAD" TIMESTAMP(3) NOT NULL,
    "billDateBS" TEXT NOT NULL,
    "subTotal" DECIMAL(12,2) NOT NULL,
    "discount" DECIMAL(12,2) NOT NULL DEFAULT 0.00,
    "taxableAmt" DECIMAL(12,2) NOT NULL,
    "vatAmount" DECIMAL(12,2) NOT NULL,
    "nonTaxableAmt" DECIMAL(12,2) NOT NULL DEFAULT 0.00,
    "totalAmount" DECIMAL(12,2) NOT NULL,
    "status" TEXT NOT NULL,
...
CREATE TABLE "Ebill" (
    ...
    CONSTRAINT "Ebill_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "CreditNote" (
    ...
    "returnDateAD" TIMESTAMP(3) NOT NULL,
    "returnDateBS" TEXT NOT NULL,
    "irdSyncStatus" TEXT NOT NULL DEFAULT 'PENDING',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "deletedAt" TIMESTAMP(3),
...
-- CreateIndex
CREATE INDEX "Ebill_invoiceId_idx" ON "Ebill"("invoiceId");
...
-- AddForeignKey
ALTER TABLE "Ebill" ADD CONSTRAINT "Ebill_invoiceId_fkey" FOREIGN KEY ("invoiceId") REFERENCES "Invoice"("id") ON DELETE CASCADE ON UPDATE CASCADE;
